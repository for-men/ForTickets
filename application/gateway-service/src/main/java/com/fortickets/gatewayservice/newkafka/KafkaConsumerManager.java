...
//    private final KafkaMonitor kafkaMonitor; // KafkaMonitor 인스턴스 추가
//
//    @Autowired
//    public KafkaConsumerManager(ConsumerFactory<String, String> consumerFactory, WebClient.Builder webClientBuilder, KafkaMonitor kafkaMonitor) {
...
//        this.kafkaMonitor = kafkaMonitor; // KafkaMonitor 초기화
//    }
//
//    // Kafka 메시지 수신 (스프링 관리)
...
//        } finally {
//            // 요청 수 감소
//            kafkaMonitor.decrementRequestCount(); // 요청 수 감소
//        }
//    }
//
//    // 재전송을 위한 HTTP 요청 메서드
...
//                    httpHeaders.set(keyValue[0], keyValue[1]);
//                }
//            })

...
values
    ...
    (2, 1, 1, 90000, 'CONFIRMED', '3 4', false, now(), 'admin@admin.com', now(), 'admin@admin.com', null, null),
    (3, 2, 2, 100000, 'CANCELED', '5 5', false, now(), 'admin@admin.com', now(), 'admin@admin.com', null, null),

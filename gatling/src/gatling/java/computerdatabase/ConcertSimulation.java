...
public class ConcertSimulation extends Simulation {
    ...
    ScenarioBuilder scn = scenario("Concert 조회 시나리오")
            ...
            .exec(session -> {
                ...
                String jwtToken = "eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjE5LCJlbWFpbCI6Im1hbmFnZXIxMkBlbWFpbC5jb20iLCJyb2xlIjoiUk9MRV9NQU5BR0VSIiwiaXNzIjoidXNlci1zZXJ2aWNlIiwiaWF0IjoxNzI5MjI3OTg5LCJleHAiOjE3MjkyMzE1ODl9.7wFx557MoLmwpPmA676CdfZOgSwokOo5NCgmlzjt2lw"; // 포스트맨에서 받은 JWT 토큰
...

    {
        ...
        setUp(scn.injectOpen(rampUsers(5000).during(1))).protocols(httpProtocol);
    }
}
